...
{
    private array $cols = [
        'ID_DATO_USUARIO', 'MAIL', 'OCUPACION', 'USER_', 'USUARIO', 'USER_SUPERIOR',
        'MAIL_SUPERIOR', 'ID_SECTOR_INTERNO', 'CODIGO_SECTOR_INTERNO',
        'FECHA_CADUCIDAD_SECTOR_INTERNO', 'ES_SECRETARIO', 'SECRETARIO', 'APELLIDO_NOMBRE',
        'ACEPTACION_TYC', 'NUMERO_CUIT', 'CARGO', 'NOMBRE', 'APELLIDO',
        'USUARIO_MODIFICACION', 'ID_LOCALIDAD', 'ID_PROVINCIA', 'VALIDAR_POLITICA',
        'ES_EXTRANJERO', 'PERMISOS', 'ID_SECTOR_ORIGINAL', 'RESETEO_PASS', 
        'BLOQUEO_LUE', 'USUARIO_APLICACION', 'DEPURABLE',
    ];
